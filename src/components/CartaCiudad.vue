    ...
    <div class="mb-8 pt-4 relative">
        <div class="flex py-6 px-3 bg-weather-secondary rounded-md shadow-md">
            <div class="flex flex-col flex-1">
                ...
                <button  @click="agregarStorage()" class="text-left" data-bs-toggle="tooltip" data-bs-placement="right"
                    title="Add to favourites"><font-awesome-icon icon="fa-solid fa-heart-circle-plus" color="white"
                        size="xl" /></button>
            </div>
